...
def load_data():
    ...
    # -------- Harmonisation des CENTRES (sans supprimer les autres) --------
    # Objectif: Inria Saclay IPP + Inria Saclay UPS + Inria Saclay => Inria Saclay
    if "Centre" in df.columns:
        # petit nettoyage robuste
    ...
    # -------- Filtrage des ANNEES 2018-2025 (on garde tous les centres) --------
